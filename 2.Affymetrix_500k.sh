...
plink --bfile affy.500.QC3 --update-ids affy.500.ids.txt --make-bed --out affy.500.QC4 
# A custom update file was used. See link for information.
#The file should be uploaded from affy.500.QC4 to GRCh37.
# Name the new, updated file affy.500.QC5
