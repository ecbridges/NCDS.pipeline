...
plink --bfile affy.500.QC7 --indep-pairwise 1000 5 0.2 --out affy.500.QC7
plink --bfile affy.500.QC7 --extract affy.500.QC7.prune.in --make-bed --pca header tabs --out affy.500.QC7.pca

#Genetate allele frequencies from clean file.
plink --bfile affy.500.QC7 --freq --out affy.500

#Now check data using Will Rayner's checking script. Script and associated files are available here: 
#	https://www.well.ox.ac.uk/~wrayner/tools/
#Run using code:
perl HRC-1000G-check-bim.pl -b affy.500.QC7.bim -f affy.500.frq -r HRC.r1-1.GRCh37.wgs.mac5.sites.tab -h
...
for CHR in {1..22};
do
plink --bfile affy.500.QC7-updated-chr${CHR} --recode vcf --out affy.500.updated.chr${CHR}
