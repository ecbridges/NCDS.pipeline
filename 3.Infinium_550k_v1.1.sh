#This is step 3 for the preparation of the Infinium 550k v1.1  array. This section will clean up
...
plink --bfile infin.1.QC6 --set-hh-missing --make-bed infin.1.QC7

#Sex check on pruned dataset.
plink --bfile infin.1.QC7 --indep-pairwise 1000 5 0.2 --out infin.1.QC7
plink --bfile infin.1.QC7 --extract infin.1.QC7.prune.in --sex-check --out infin.1.sex
grep PROBLEM infin.1.sex.sexcheck >> infin.1.sex.probs.txt

#Remove individuals with sex errors.
plink --brfile infin.1.QC7 --remove infin.1.sex.probs.txt --make-bed --out infin.1.QC8
